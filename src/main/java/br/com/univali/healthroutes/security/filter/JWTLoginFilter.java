package br.com.univali.healthroutes.security.filter;
...
import br.com.univali.healthroutes.security.model.AccountCredentials;
...
public class JWTLoginFilter extends AbstractAuthenticationProcessingFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		return getAuthenticationManager().authenticate(new HealthRoutesUserDetails(
