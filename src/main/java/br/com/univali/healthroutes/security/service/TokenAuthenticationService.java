package br.com.univali.healthroutes.security.service;
...
import br.com.univali.healthroutes.security.exception.AuthException;
...
public class TokenAuthenticationService {
	...
	@Autowired
	public TokenAuthenticationService(UserDao userRepository) {
	...
	private static String jwtLogin(Authentication auth, Date exp, String[] roles) {
		...
		Map<String, Object> detais = ((HealthRoutesUserDetails) auth.getPrincipal()).getExtraData();
			...
			try {
				...
				if (claimRoles != null) {
					...
					if (user != null) {
						...
						return new HealthRoutesUserDetails(user, null, authorities, extraData);
					}
				}
