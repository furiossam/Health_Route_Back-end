...
public class Root{
    ...
    public Double getLat() {
    	return this.resourceSets.get(0).getResources().get(0).getPoint().getCoordinates().get(0);
    }
    
    public Double getLong() {
    	return this.resourceSets.get(0).getResources().get(0).getPoint().getCoordinates().get(1);
    }
}
